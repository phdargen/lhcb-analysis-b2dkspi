j = Job(name = "17D")
try:
    myApp = prepareGaudiExec("DaVinci","v44r10p2", myPath=".")
except:
    myApp = GaudiExec()
    myApp.directory = "./DaVinciDev_v44r10p2"

j.application = myApp
j.application.options = ["data_type_2017.py","main_options.py"]
j.backend=Dirac()
...
#datatmp=BKQuery("/LHCb/Collision17/Beam6500GeV-VeloClosed-MagUp/Real Data/Reco17/Stripping29r2/90000000/BHADRON.MDST", dqflag=["OK"]).getDataset()
