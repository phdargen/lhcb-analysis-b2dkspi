...
@date   2017-12-07
"""
#stripping version --> DaVinci v41r4p1 ?
...
stck = StrippingTCK(HDRLocation = '/Event/Strip/Phys/DecReports', TCK=0x41412810)# TCK = 0xVVVVSSSS, where VVVV is the DaVinci version, and SSSS the Stripping number
