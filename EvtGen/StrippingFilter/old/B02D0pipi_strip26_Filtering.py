...
@date   2017-03-21
"""
#stripping version --> DaVinci v41r2
...
stck = StrippingTCK(HDRLocation = '/Event/Strip/Phys/DecReports', TCK=0x41202600)# TCK = 0xVVVVSSSS, where VVVV is the DaVinci version, and SSSS the Stripping number
