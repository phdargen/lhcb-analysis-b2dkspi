"""
Stripping filtering file for B0 -> D0pipi MC
@author MarK Whitehead
@date   2017-03-21
"""
#stripping version --> DaVinci v36r1p3
...
# Select my lines
AllStreams = StrippingStream("B02D0pipi.Strip")
linesToAdd = []
MyLines = [ 'StrippingB02D0PiPiD2HHBeauty2CharmLine',
            'StrippingB02D0KPiD2HHBeauty2CharmLine',
            'StrippingB02D0KKD2HHBeauty2CharmLine',
            'StrippingB2D0PiPiD2HHBeauty2CharmLine',
            'StrippingB2D0KPiD2HHBeauty2CharmLine'
          ]
...
stck = StrippingTCK(HDRLocation = '/Event/Strip/Phys/DecReports', TCK=0x36132100)# TCK = 0xVVVVSSSS, where VVVV is the DaVinci version, and SSSS the Stripping number
