...
stck = StrippingTCK(HDRLocation = '/Event/Strip/Phys/DecReports', TCK=0x36132110)# TCK = 0xVVVVSSSS, where VVVV is the DaVinci version, and SSSS the Stripping number
