...
void plot_efficiencies( TFile* file, Int_t type = 2, TDirectory* BinDir, TString outDir = "plots")
{
...
void efficiencies( TString fin = "TMVA.root", Int_t type = 2, Bool_t useTMVAStyle = kTRUE , TString outDir = "plots")
{
