...
{   
   ...
   if(sample == "1"){
	inFileName="/auto/data/dargent/Bu2JpsiKpipi/data/data_preselected_sweight_bdt_peak.root";
	outFileName="/auto/data/dargent/Bu2JpsiKpipi/data/data_bdt1_peak.root";
   }
   else{
	inFileName="/auto/data/dargent/Bu2JpsiKpipi/data/data_bdt1_peak.root";
	outFileName="/auto/data/dargent/Bu2JpsiKpipi/data/data_bdt_peak.root";
   }
...
*/
   ...
   TString dir    = "weights/";
   TString prefix = ("peak_TMVA_s"+sample).c_str();
   ...
   dataTree->SetBranchAddress( "Kplus_PIDK", &mvar2[3] );
