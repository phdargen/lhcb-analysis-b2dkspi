...
*/
  ...
  Double_t Bplus_TAU;
  Double_t J_psi_1S_PE, J_psi_1S_PX, J_psi_1S_PY, J_psi_1S_PZ;
  ...
  //dataTree->SetBranchAddress("Bplus_TAU",&Bplus_TAU) ;
  ...
  ///output file
  TFile *target = new TFile("/auto/data/dargent/jpsi/data_bdt_nosweight5.root","RECREATE" );
  ...
  tree->Branch("Bplus_TAU",&Bplus_TAU) ;
