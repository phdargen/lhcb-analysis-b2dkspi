...
{   
   ...
   if(sample == "1"){
	inFileName="/auto/data/dargent/Bu2JpsiKpipi/data/data_preselected_sweight_bdt.root";
	outFileName="/auto/data/dargent/Bu2JpsiKpipi/data/data_bdt1_PIDK.root";
   }
   else{
	inFileName="/auto/data/dargent/Bu2JpsiKpipi/data/data_bdt1_PIDK.root";
	outFileName="/auto/data/dargent/Bu2JpsiKpipi/data/data_bdt_PIDK.root";
   }
