...
{   
   ...
   Float_t spec1;
   reader->AddSpectator( "Bplus_MM",   &spec1 );
...
*/
   ...
   //TString fname = "/auto/data/dargent/jpsi/data_selected_sweight3.root";
   //TString fname = "/auto/data/dargent/jpsi/data_sweight_split2.root";
...
*/
   TTree* dataTree = (TTree*)input->Get("split2");
   ///TTree* dataTree = (TTree*)input->Get("merged");
  ...
  ///output file
  //TFile *target = new TFile("/auto/data/dargent/jpsi/data_bdt_sweight_high.root","RECREATE" );
  TFile *target = new TFile("/auto/data/dargent/preselection3/data_bdt_split2_noPsiCut.root","RECREATE" );
