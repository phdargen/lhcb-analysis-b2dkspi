...
{   
   ...
   //inFileName="/auto/data/dargent/mc/BuJPsiX_preselected_forBDT.root";
   //outFileName="/auto/data/dargent/mc/BuJPsiX_BDT.root";

   inFileName="/auto/data/dargent/Bu2JpsiKpipi/MC/MC_preselected_forBDT_PIDcorr_bkg.root";
   outFileName="/auto/data/dargent/Bu2JpsiKpipi/MC/MC_BDT_bkg.root";
