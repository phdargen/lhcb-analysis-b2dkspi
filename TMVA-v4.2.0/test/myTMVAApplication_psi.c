...
{   
   ...
   string outFileName;
	...
	inFileName="/auto/data/dargent/Bu2psiKpipi/data/data_preselected_sweight_bdt.root";
	outFileName="/auto/data/dargent/Bu2psiKpipi/data/data_bdt.root";
...
*/
   ...
   TString dir    = "weights/";
   TString prefix = ("TMVA_psi_s"+sample).c_str();
