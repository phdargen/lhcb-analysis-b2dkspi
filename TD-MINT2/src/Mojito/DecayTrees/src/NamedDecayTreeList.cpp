...
int NamedDecayTreeList::makeB02DKspiList() {
    ...
    dk = new DecayTree(511);
    dk->addDgtr(310, 10423)->addDgtr(-411,211);
    this->add(*dk);
    delete dk;
    ...
    dk = new DecayTree(511);
    dk->addDgtr(310, 9425)->addDgtr(-411,211);
    this->add(*dk);
    delete dk;
    
    dk = new DecayTree(511);
    dk->addDgtr(310, 99425)->addDgtr(-411,211);
    this->add(*dk);
    delete dk;
    
    dk = new DecayTree(511);
    dk->addDgtr(310, 999425)->addDgtr(-411,211);
    this->add(*dk);
    delete dk;
    ...
    dk = new DecayTree(511);
    dk->addDgtr(211,-9435)->addDgtr(-411,310);
    this->add(*dk);
    delete dk;    

    dk = new DecayTree(511);
    dk->addDgtr(211,-99435)->addDgtr(-411,310);
    this->add(*dk);
    delete dk;    

    dk = new DecayTree(511);
    dk->addDgtr(211,-999435)->addDgtr(-411,310);
    this->add(*dk);
    delete dk;    
...
//======================== 4 body decays ========================
int NamedDecayTreeList::makeDsKpipiList() {
    
    DecayTree* dk=0;
    
    // B->Ds K1(1270); K1->K*(892) pi; K*->K pi    
    ...
    // B->Ds K1(1270); K1->K rho(770); rho->pi pi    
    dk = new DecayTree(531);
    k1 = DecayTree(10323);
    ...
    // B->Ds K1(1270); K1->K rho(1450); rho->pi pi    
    dk = new DecayTree(531);
    k1 = DecayTree(10323);
    k1.addDgtr(321, 100113)->addDgtr(211,-211);
    dk->addDgtr(-431);
    dk->addDgtr(&k1);
    this->add(*dk); 
    this->add(AmpInitialiser(*dk, "GS"));
    ...
    // B->Ds K1(1270); K1->K omega;    
    dk = new DecayTree(531);
    k1 = DecayTree(10323);
    k1.addDgtr(321, 223)->addDgtr(211,-211);
    dk->addDgtr(-431);
    dk->addDgtr(&k1);
    this->add(*dk); 
    this->add(AmpInitialiser(*dk, "GS"));
    ...
    dk = new DecayTree(531);
    dk->addDgtr(-431, 10323)->addDgtr(211, 999041)->addDgtr(321,-211);
    this->add(*dk);
    delete dk;

    dk = new DecayTree(531);
    dk->addDgtr(-431, 10323)->addDgtr(211, 9981)->addDgtr(321,-211);
    this->add(*dk);
    delete dk;
    
    // B->Ds K1(1400); K1->K*(892) pi; K*->K pi
    dk = new DecayTree(531);
    k1 = DecayTree(20323);
    k1.addDgtr(211, 313)->addDgtr(321,-211);
    dk->addDgtr(-431);
    ...
    // B->Ds K1(1400); K1->K rho(770); rho->pi pi
    dk = new DecayTree(531);
    k1 = DecayTree(20323);
    k1.addDgtr(321, 113)->addDgtr(211,-211);
    dk->addDgtr(-431);
    ...
    dk = new DecayTree(531);
    dk->addDgtr(-431, 9000323)->addDgtr(321, 9993)->addDgtr(211,-211);
    this->add(*dk);
    ...
    // B->Ds K*(1410); K*->K rho(770); rho->pi pi
    dk = new DecayTree(531);
    dk->addDgtr(-431, 100323)->addDgtr(321, 113)->addDgtr(211,-211);
    this->add(AmpInitialiser(*dk, "GS"));
    this->add(AmpInitialiser(*dk, "RhoOmegaGS"));
    this->add(*dk);
    delete dk;
    ...
    dk = new DecayTree(531);
    dk->addDgtr(-431, 100323)->addDgtr(321, 100113)->addDgtr(211,-211);
    this->add(AmpInitialiser(*dk, "GS"));
    this->add(AmpInitialiser(*dk, "RhoOmegaGS"));
    this->add(*dk);
    delete dk;
    ...
    // B->Ds K2*(1430); K2->K*(892) pi; K*->K pi
    dk = new DecayTree(531);
    dk->addDgtr(-431, 325)->addDgtr(211, 313)->addDgtr(321,-211);
    this->add(*dk);
    delete dk;
    
    // B->Ds K2*(1430); K2->K rho(770); rho->pi pi
    dk = new DecayTree(531);
    dk->addDgtr(-431, 325)->addDgtr(321, 113)->addDgtr(211,-211);
    this->add(AmpInitialiser(*dk, "GS"));
    this->add(AmpInitialiser(*dk, "RhoOmegaGS"));
    this->add(*dk);
    delete dk;
    
    // B->Ds K(1460); K->K*(892) pi; K*->K pi  
    dk = new DecayTree(531);
    ...
    dk = new DecayTree(531);
    dk->addDgtr(-431, 100321)->addDgtr(321, 113)->addDgtr(211,-211);
    this->add(AmpInitialiser(*dk, "GS"));
    this->add(AmpInitialiser(*dk, "RhoOmegaGS"));
    this->add(AmpInitialiser(*dk, "MI_100321"));
    ...
    dk = new DecayTree(531);
    dk->addDgtr(-431, 100321)->addDgtr(321, 9010221)->addDgtr(211,-211);
    this->add(AmpInitialiser(*dk, "Flatte"));
    this->add(AmpInitialiser(*dk, "MI_100321"));
    ...
    // B->Ds K(1460); K->K sigma  
    dk = new DecayTree(531);
    dk->addDgtr(-431, 100321)->addDgtr(321, 999001)->addDgtr(211,-211);
    this->add(AmpInitialiser(*dk, "Bugg"));
    this->add(AmpInitialiser(*dk, "MI_100321"));
    this->add(AmpInitialiser(*dk, "MI_100321Bugg"));
    this->add(*dk);   
    delete dk;
    
    // B->Ds K(1460); K-> K0^*(1430) pi; K0^*->K pi  
    dk = new DecayTree(531);
    ...
    // B->Ds K2(1580); K2->K*(892) pi; K*->K pi
    dk = new DecayTree(531);
    dk->addDgtr(-431, 9000325)->addDgtr(211, 313)->addDgtr(321,-211);
    this->add(*dk);
    delete dk;
    
    // B->Ds K2(1580); K2->K rho(770); rho->pi pi
    dk = new DecayTree(531);
    dk->addDgtr(-431, 9000325)->addDgtr(321, 113)->addDgtr(211,-211);
    this->add(AmpInitialiser(*dk, "GS"));
    this->add(AmpInitialiser(*dk, "RhoOmegaGS"));
    this->add(*dk);
    delete dk;

    // B->Ds K*(1680); K*->K*(892) pi; K*->K pi
    dk = new DecayTree(531);
    dk->addDgtr(-431, 30323)->addDgtr(211, 313)->addDgtr(321,-211);
    this->add(*dk);
    delete dk;
    
    // B->Ds K*(1680); K*->K rho(770); rho->pi pi
    dk = new DecayTree(531);
    dk->addDgtr(-431, 30323)->addDgtr(321, 113)->addDgtr(211,-211);
    this->add(AmpInitialiser(*dk, "GS"));
    this->add(AmpInitialiser(*dk, "RhoOmegaGS"));
    this->add(*dk);
    delete dk;
    
    // B->Ds K2(1770); K2->K*(892) pi; K*->K pi
    dk = new DecayTree(531);
    dk->addDgtr(-431, 10325)->addDgtr(211, 313)->addDgtr(321,-211);
    this->add(*dk);
    delete dk;
    
    // B->Ds  K2(1770); K2->K rho(770); rho->pi pi
    dk = new DecayTree(531);
    dk->addDgtr(-431, 10325)->addDgtr(321, 113)->addDgtr(211,-211);
    this->add(AmpInitialiser(*dk, "GS"));
    this->add(AmpInitialiser(*dk, "RhoOmegaGS"));
    this->add(*dk);
    delete dk;
    
    // B->Ds K2(1770); K2->K f0(980); f2->pi pi
    dk = new DecayTree(531);
    dk->addDgtr(-431, 10325)->addDgtr(321, 9010221)->addDgtr(211,-211);
    this->add(AmpInitialiser(*dk, "Flatte"));
    this->add(*dk);
    delete dk;
    
    // B->Ds K2(1770); K2->K f2(1270); f2->pi pi
    dk = new DecayTree(531);
    dk->addDgtr(-431, 10325)->addDgtr(321, 225)->addDgtr(211,-211);
    this->add(*dk);
    delete dk;
    
    // B->Ds K2(1770); K2->K2*(1430) pi; K2*->K pi
    dk = new DecayTree(531);
    dk->addDgtr(-431, 10325)->addDgtr(211, 315)->addDgtr(321,-211);
    this->add(*dk);
    delete dk;
    
    
    //Bs -> (Ds K)_S rho(770), rho(770)->pi+pi-
    dk = new DecayTree(531);
    dk->addDgtr(9981)->addDgtr(321, -431);
    ...
    dk = new DecayTree(531);
    dk->addDgtr(9009981)->addDgtr(321, -431);
    dk->addDgtr(113)->addDgtr(211, -211);
    add(*dk);
    this->add(AmpInitialiser(*dk, "RhoOmegaGS"));
    this->add(AmpInitialiser(*dk, "GS"));
    ...
    dk = new DecayTree(531);
    dk->addDgtr(9993)->addDgtr(321, -431);
    dk->addDgtr(113)->addDgtr(211, -211);
    add(*dk);
    this->add(AmpInitialiser(*dk, "NonResGS"));
    this->add(AmpInitialiser(*dk, "NonRes"));
    ...
    dk = new DecayTree(531);
    dk->addDgtr(9009993)->addDgtr(321, -431);
    dk->addDgtr(113)->addDgtr(211, -211);
    add(*dk);
    this->add(AmpInitialiser(*dk, "RhoOmegaGS"));
    this->add(AmpInitialiser(*dk, "GS"));
    ...
    //Bs -> (Ds K)_S rho(1700), rho->pi+pi-
    dk = new DecayTree(531);
    dk->addDgtr(9981)->addDgtr(321, -431);
    dk->addDgtr(30113)->addDgtr(211, -211);
    add(*dk);
    this->add(AmpInitialiser(*dk, "RhoOmegaGS"));
    this->add(AmpInitialiser(*dk, "GS"));
    this->add(AmpInitialiser(*dk, "NonResGS"));
    ...
    //Bs -> (Ds K)_T f2(1270)
    dk = new DecayTree(531);
    dk->addDgtr(9985)->addDgtr(321, -431);
    dk->addDgtr(225)->addDgtr(211, -211);
    add(*dk);
    delete dk;
    ...
    dk = new DecayTree(531);
    dk->addDgtr(9009981)->addDgtr(211, -431);
    dk->addDgtr(313)->addDgtr(321, -211);
    add(*dk);
    delete dk;
    ...
    dk = new DecayTree(531);
    dk->addDgtr(9981)->addDgtr(211, -431);
    dk->addDgtr(9999041)->addDgtr(321, -211);
    add(*dk);
    this->add(AmpInitialiser(*dk,"NonRes"));
    ...
    //Bs -> (Ds pi)_V K*(892)
    dk = new DecayTree(531);
    dk->addDgtr(9993)->addDgtr(211, -431);
    dk->addDgtr(313)->addDgtr(321, -211);
    add(*dk);
    dk->getVal().setL(1);
    add(*dk);
    ...
    dk = new DecayTree(531);
    dk->addDgtr(9009993)->addDgtr(211, -431);
    dk->addDgtr(313)->addDgtr(321, -211);
    add(*dk);
    dk->getVal().setL(1);
    add(*dk);
    ...
    //Bs -> D(s1)(2536)- pi+, D(s1)(2536)->Ds- pi- pi+
    dk = new DecayTree(531);
    dk->addDgtr(321, -10433)->addDgtr(-431,999981)->addDgtr(211, -211);
    add(*dk);
    this->add(AmpInitialiser(*dk,"NonRes"));
    this->add(AmpInitialiser(*dk,"NonResPow"));
    this->add(AmpInitialiser(*dk,"NonResExp"));
    ...
    //Bs -> D(s1)(2536)- pi+, D(s1)(2536)->Ds- rho
    dk = new DecayTree(531);
    dk->addDgtr(321, -10433)->addDgtr(-431,113)->addDgtr(211, -211);
    add(*dk);
    this->add(AmpInitialiser(*dk, "RhoOmegaGS"));
    this->add(AmpInitialiser(*dk, "GS"));
    delete dk;
    
    //Bs -> D(s1)(2536)- pi+, D(s1)(2536)->Ds- sigma
    dk = new DecayTree(531);
    dk->addDgtr(321, -10433)->addDgtr(-431,999001)->addDgtr(211, -211);
    add(*dk);
    this->add(AmpInitialiser(*dk, "Bugg"));
    delete dk;
    ...
    dk = new DecayTree(531);
    dk->addDgtr(9981)->addDgtr(321, -431);
    dk->addDgtr(99981)->addDgtr(211, -211);
    add(*dk);
    this->add(AmpInitialiser(*dk, "NonResExp"));
    this->add(AmpInitialiser(*dk, "NonRes"));
    this->add(AmpInitialiser(*dk,"NonResPow"));
    ...
    dk = new DecayTree(531);
    dk->addDgtr(9981)->addDgtr(211, -431);
    dk->addDgtr(99981)->addDgtr(321, -211);
    add(*dk);
    this->add(AmpInitialiser(*dk, "NonResExp"));
    this->add(AmpInitialiser(*dk, "NonRes"));
    this->add(AmpInitialiser(*dk,"NonResPow"));
    ...
    //Bs -> NA K+, NA -> Ds rho
    dk = new DecayTree(531);
    dk->addDgtr(321, 9983)->addDgtr(-431,113)->addDgtr(211, -211);
    add(*dk);
    this->add(AmpInitialiser(*dk,"NonRes"));
    this->add(AmpInitialiser(*dk,"NonResPow"));
    this->add(AmpInitialiser(*dk,"NonResExp"));
    ...
    //Bs -> NA K+, NA -> Ds sigma
    dk = new DecayTree(531);
    dk->addDgtr(321, 9983)->addDgtr(-431,999001)->addDgtr(211, -211);
    add(*dk);
    this->add(AmpInitialiser(*dk,"NonRes"));
    this->add(AmpInitialiser(*dk,"NonResPow"));
    this->add(AmpInitialiser(*dk,"NonResExp"));
    this->add(AmpInitialiser(*dk, "Bugg"));
    this->add(AmpInitialiser(*dk, "NonResBugg"));
    delete dk;

    //Bs -> NS K+, NS -> Ds rho
    dk = new DecayTree(531);
    dk->addDgtr(321, 9981)->addDgtr(-431,113)->addDgtr(211, -211);
    add(*dk);
    this->add(AmpInitialiser(*dk,"NonRes"));
    this->add(AmpInitialiser(*dk,"NonResPow"));
    this->add(AmpInitialiser(*dk,"NonResExp"));
    ...
    //Bs -> NS K+, NS -> Ds sigma
    dk = new DecayTree(531);
    dk->addDgtr(321, 9981)->addDgtr(-431,999001)->addDgtr(211, -211);
    add(*dk);
    this->add(AmpInitialiser(*dk,"NonRes"));
    this->add(AmpInitialiser(*dk,"NonResPow"));
    this->add(AmpInitialiser(*dk,"NonResExp"));
...
int NamedDecayTreeList::makeDspipipiList() {
    
    DecayTree* dk=0;
    DecayTree* a1=0;
    
    //Bs -> pi(1300) Ds, pi->rho(770)pi+, rho->pi+pi-   [S-WAVE]
    dk = new DecayTree(531);
    dk->addDgtr(-431, 100211)->addDgtr(211, 113)->addDgtr(211, -211);
    add(*dk);
    this->add(AmpInitialiser(*dk, "GS"));
    this->add(AmpInitialiser(*dk, "RhoOmegaGS"));
    delete dk;
    
    //Bs -> pi(1300) Ds, pi(1300)->sigma_1 pi+
    dk = new DecayTree(531);
    dk->addDgtr(-431, 100211)->addDgtr(211,999001)->addDgtr(211, -211);
    add(*dk);
    this->add(AmpInitialiser(*dk, "Bugg"));
    delete dk;
    
    
    //Bs -> a1(1260) Ds, a1(1260)->rho(770)pi+, rho->pi+pi-   [S-WAVE]
    dk = new DecayTree(531);
    dk->addDgtr(-431, 20213)->addDgtr(211, 113)->addDgtr(211, -211);
    add(*dk);
    this->add(AmpInitialiser(*dk, "GS"));
    this->add(AmpInitialiser(*dk, "RhoOmegaGS"));
    this->add(AmpInitialiser(*dk, "SBW_113"));
    ...
    //Bs -> a1(1260) Ds, a1(1260)->rho(1450)pi+, rho->pi+pi-   [S-WAVE]
    dk = new DecayTree(531);
    dk->addDgtr(-431, 20213)->addDgtr(211, 100113)->addDgtr(211, -211);
    add(*dk);
    this->add(AmpInitialiser(*dk, "RhoOmegaGS"));
    this->add(AmpInitialiser(*dk, "GS"));
    delete dk;
    
    //Bs -> a1(1260) Ds, a1(1260)->rho(1450)pi+, rho->pi+pi-   [D-WAVE decay of a1]
    dk = new DecayTree(531);
    a1 = new DecayTree(20213);
    a1->getVal().setL(2);
    ...
    //Bs -> a1(1260) Ds, a1(1260)->sigma_1 pi+
    dk = new DecayTree(531);
    ...
    dk = new DecayTree(531);
    dk->addDgtr(-431, 20213)->addDgtr(211,225)->addDgtr(211, -211);
    add(*dk);
    this->add(AmpInitialiser(*dk, "HistoPS_225"));
    delete dk;
    
    //Bs -> a1(1260) Ds, a1(1260)->f0(1370) pi+
    dk = new DecayTree(531);
    dk->addDgtr(-431, 20213)->addDgtr(211,30221)->addDgtr(211, -211);
    add(*dk);
    add(AmpInitialiser(*dk, "HistoPS_30221"));
    add(AmpInitialiser(*dk, "Bugg"));
    delete dk;
    
    //Bs -> a1(1260) Ds, a1(1260)->f0(980) pi+
    dk = new DecayTree(531);
    dk->addDgtr(-431, 20213)->addDgtr(211,9010221)->addDgtr(211, -211);
    add(*dk);
    this->add(AmpInitialiser(*dk,"Flatte"));
    delete dk;
    
    //Bs -> a1(1260) Ds, a1(1260)->NS pi+
    dk = new DecayTree(531);
    dk->addDgtr(-431, 20213)->addDgtr(211,9981)->addDgtr(211, -211);
    add(*dk);
    this->add(AmpInitialiser(*dk,"NonRes"));
    this->add(AmpInitialiser(*dk,"NonResExp"));
    delete dk;
    
    //Bs -> a1(1640) Ds, a1->rho(770)pi+, rho->pi+pi-   [S-WAVE]
    dk = new DecayTree(531);
    dk->addDgtr(-431, 9920213)->addDgtr(211, 113)->addDgtr(211, -211);
    add(*dk);
    this->add(AmpInitialiser(*dk, "GS"));
    this->add(AmpInitialiser(*dk, "RhoOmegaGS"));
    delete dk;
    
    //Bs -> a1(1640) Ds, a1->rho(770)pi+, rho->pi+pi-   [D-WAVE decay of a1]
    dk = new DecayTree(531);
    ...
    //Bs -> a1(1640) Ds, a1->rho(1450)pi+, rho->pi+pi-   [S-WAVE]
    dk = new DecayTree(531);
    dk->addDgtr(-431, 9920213)->addDgtr(211, 100113)->addDgtr(211, -211);
    add(*dk);
    this->add(AmpInitialiser(*dk, "RhoOmegaGS"));
    this->add(AmpInitialiser(*dk, "GS"));
    delete dk;
    
    //Bs -> a1(1640) Ds, a1->rho(1450)pi+, rho->pi+pi-   [D-WAVE decay of a1]
    dk = new DecayTree(531);
    a1 = new DecayTree(9920213);
    a1->getVal().setL(2);
    a1->addDgtr(211, 100113)->addDgtr(211, -211);
    ...
    //Bs -> a1(1640) Ds, a1->sigma_1 pi+
    dk = new DecayTree(531);
    dk->addDgtr(-431, 9920213)->addDgtr(211,999001)->addDgtr(211, -211);
    add(*dk);
    this->add(AmpInitialiser(*dk, "Bugg"));
    delete dk;
    
    //Bs -> a1(1640) Ds, a1->f2(1270) pi+, rho->pi+pi-
    dk = new DecayTree(531);
    dk->addDgtr(-431, 9920213)->addDgtr(211,225)->addDgtr(211, -211);
    add(*dk);
    this->add(AmpInitialiser(*dk, "HistoPS_225"));
    delete dk;
    
    //Bs -> a1(1640) Ds, a1->f0(1370) pi+
    dk = new DecayTree(531);
    dk->addDgtr(-431, 9920213)->addDgtr(211,30221)->addDgtr(211, -211);
    add(*dk);
    add(AmpInitialiser(*dk, "HistoPS_30221"));
    add(AmpInitialiser(*dk, "Bugg"));
    delete dk;
    
    //Bs -> a1(1640) Ds, a1->f0(980) pi+
    dk = new DecayTree(531);
    dk->addDgtr(-431, 9920213)->addDgtr(211,9010221)->addDgtr(211, -211);
    add(*dk);
    this->add(AmpInitialiser(*dk,"Flatte"));
    delete dk;
    
    //Bs -> a1(1640) Ds, a1->NS pi+
    dk = new DecayTree(531);
    dk->addDgtr(-431, 9920213)->addDgtr(211,9981)->addDgtr(211, -211);
    add(*dk);
    this->add(AmpInitialiser(*dk,"NonRes"));
    this->add(AmpInitialiser(*dk,"NonResExp"));
    delete dk;
    
    // Bs -> pi2(1670) Ds, pi2->f2(1270) pi, f2->pipi
    dk = new DecayTree(531);
    dk->addDgtr(-431, 10215)->addDgtr(211, 225)->addDgtr(211, -211);
    add(*dk);
    delete dk;
    
    // Bs -> pi2(1670) Ds, pi2->f0(600) pi, f0(600)->pipi
    dk = new DecayTree(531);
    dk->addDgtr(-431, 10215)->addDgtr(211, 999001)->addDgtr(211, -211);
    this->add(AmpInitialiser(*dk, "Bugg"));
    add(*dk);
    delete dk;
    
    // Bs -> pi2(1670) Ds, pi2->rho pi
    dk = new DecayTree(531);
    dk->addDgtr(-431, 10215)->addDgtr(211, 113)->addDgtr(211, -211);
    add(*dk);
    this->add(AmpInitialiser(*dk, "GS"));
    this->add(AmpInitialiser(*dk, "RhoOmegaGS"));
    delete dk;
    ...
    //Bs -> D(s1)(2536)- pi+, D(s1)(2536)->Ds- pi- pi+
    dk = new DecayTree(531);
    dk->addDgtr(211, -10433)->addDgtr(-431,9981)->addDgtr(211, -211);
    add(*dk);
    this->add(AmpInitialiser(*dk,"NonRes"));
    this->add(AmpInitialiser(*dk,"NonResExp"));
    delete dk;
    ...
    //Bs -> D(s1)(2536)- pi+, D(s1)(2536)->Ds- rho
    dk = new DecayTree(531);
    dk->addDgtr(211, -10433)->addDgtr(-431,113)->addDgtr(211, -211);
    add(*dk);
    this->add(AmpInitialiser(*dk, "RhoOmegaGS"));
    this->add(AmpInitialiser(*dk, "GS"));
    delete dk;
    
    //Bs -> (Ds pi)_S rho(770), rho(770)->pi+pi-
    dk = new DecayTree(531);
    dk->addDgtr(9981)->addDgtr(211, -431);
    dk->addDgtr(113)->addDgtr(211, -211);
    add(*dk);
    ...
    //Bs -> (Ds pi)_V rho(770), rho(770)->pi+pi-
    dk = new DecayTree(531);
    dk->addDgtr(9993)->addDgtr(211, -431);
    dk->addDgtr(113)->addDgtr(211, -211);
    add(*dk);
    ...
    //Bs -> (Ds pi)_S rho(1700), rho->pi+pi-
    dk = new DecayTree(531);
    dk->addDgtr(9981)->addDgtr(211, -431);
    dk->addDgtr(30113)->addDgtr(211, -211);
    add(*dk);
    ...
    //Bs -> (Ds pi)_V rho(1700), rho->pi+pi-
    dk = new DecayTree(531);
    dk->addDgtr(9993)->addDgtr(211, -431);
    dk->addDgtr(30113)->addDgtr(211, -211);
    add(*dk);
    ...
    //Bs -> (Ds pi)_T f2(1270)  
    dk = new DecayTree(531);
    dk->addDgtr(9985)->addDgtr(211, -431);
    dk->addDgtr(225)->addDgtr(211, -211);
    add(*dk);
    delete dk;
...
int NamedDecayTreeList::makeKKpipiList(){
  ...
  dk = new DecayTree(421);
  dk->addDgtr(-321, 10323)->addDgtr(+321, 100113)->addDgtr(211, -211);
  this->add(AmpInitialiser(*dk, "RHO_OMEGA"));
  this->add(AmpInitialiser(*dk, "GS"));
  this->add(AmpInitialiser(*dk, "RhoOmegaGS"));
  this->add(*dk);
  ...
  dk = new DecayTree(421);
  DecayTree* R1 = new DecayTree(10323);
  dk->addDgtr(-321);
  R1->addDgtr( 211, 313)->addDgtr( 321, -211);
  dk->addDgtr(R1);
  add(*dk);
  delete dk;
  R1->getVal().setL(2);
  ...
  dk = new DecayTree(421);
  dk->addDgtr(-321, 20323)->addDgtr(+321, 113)->addDgtr(211, -211);
  this->add(AmpInitialiser(*dk, "RHO_OMEGA"));
  this->add(AmpInitialiser(*dk, "GS"));
  this->add(AmpInitialiser(*dk, "RhoOmegaGS"));
  this->add(*dk);
  ...
  dk = new DecayTree(421);
  dk->addDgtr(-321, 20323)->addDgtr(+321, 223)->addDgtr(211, -211);
  this->add(*dk);
  delete dk;
...
int NamedDecayTreeList::makeK3piList(){
  ...
  dk->addDgtr(R1);
  add(AmpInitialiser(*dk, "RhoOmegaGS"));
  ...
  R1 = new DecayTree(-10323);
  dk->addDgtr(211);
  R1->addDgtr( -321,100113  )->addDgtr( 211,-211);
  dk->addDgtr(R1);
  add(AmpInitialiser(*dk, "RhoOmegaGS"));
  add(AmpInitialiser(*dk, "GS"));
  add(*dk);
  ...
  dk = new DecayTree(421);
  dk->addDgtr(211 , -100321)->addDgtr( -211, 10311)->addDgtr( 211, -321);
  add(AmpInitialiser(*dk, "Lass"));
  add(*dk);
  delete dk;

  dk = new DecayTree(421);
  dk->addDgtr(211 , -100321)->addDgtr( -321, 999001)->addDgtr( 211, -211);
  add(AmpInitialiser(*dk, "Bugg"));
  add(*dk);
  delete dk;
